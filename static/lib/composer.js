...
define('composer', [
	...
	async function post(post_uuid, anonymous = false) {
		var postData = composer.posts[post_uuid];
		var postContainer = $('.composer[data-uuid="' + post_uuid + '"]');
		...
		const submitBtn = anonymous ? postContainer.find('.composer-submit-anonymous') : postContainer.find('.composer-submit');
